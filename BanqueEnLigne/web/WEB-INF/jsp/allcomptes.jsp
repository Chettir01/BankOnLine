        ...
        <table>
            ...
            <%
                ...
                for (int i = 0; i < l.size(); i++) {
                    ...
                    out.print("<td>" + "<form action=\"detailscompte.htm\" method=\"get\">" + "<input type=\"hidden\" name=\"compte\" value=\""+l.get(i).getID_compte()+"\"/>"+"<input class=\"form-control btn-success\" Type=\"submit\" VALUE=\"Details\"/>"+ "</form>" + "</td>");
                    out.print("</tr>");
                }
