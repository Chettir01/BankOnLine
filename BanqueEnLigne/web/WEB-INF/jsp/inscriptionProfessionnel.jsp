...
<html>
    <head>
        ...
        <title>Inscription d'un professionnel</title>
    ...
    <body>
        ...
        <form  action="inscriptionOnSuccesPro.htm" method="Post">
            
            <div class=" form-group">
            <label for="nomEntreprise">Nom de l'entreprise: </label><input class="form-control" id="nom" name="nomEntreprise" type="text"> 
            </div>
            <div class="form-group">
            <label for="acivity">Secteur d'activité : </label> <input id="prenom" class="form-control" name="activity" type="text"> 
            </div>
            <div class="form-group">
